...
print("\n" + color.BOLD + color.UNDERLINE + color.PURPLE + "Ejercicio 2: REGRESIÓN LINEAL SIMPLE" + color.END)
...
# Guardar gráfico
plt.savefig(os.path.join(output_dir, 'ej2_residuos.png'), dpi=300, bbox_inches='tight')
...
with open(os.path.join(output_dir, 'ej2_metricas_regresion.txt'), 'w') as f:
